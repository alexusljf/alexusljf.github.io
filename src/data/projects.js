export const personalProjects = [
  ...
  },
  {
    ...
    description2:
      "Users can easily input a city's name and receive personalized run recommendations based on real-time weather conditions.",
    description3:
...
export const academicProjects = [
  {
    ...
    description1:
      "We developed a website where users can view and compare housing prices in Singapore; in a group of 6.",
    description2:
      "I mainly worked on the Frontend and formulated website’s functionality utilising various diagrams, such as Use-Case diagrams, Sequence Diagrams and State Diagrams.",
    description3:
      "We collaborated on Jira using Agile methodology practices. Brainstormed and pitched ideas for features to expand utility and functionality.",
  ...
  },
  {
    ...
    description1:
      "We developed a cinema management system where users can book tickets and staff can update the cinema database; in a group of 5.",
    description2:
      "I mainly organised application documentation, created essential entity classes and rewrote code to be more readable.",
    description3:
      "Applied SOLID design principles and Object-Oriented Programming concepts to design an application with high cohesion and low coupling.",
  ...
  },
  {
    ...
    description1:
      "Performed data exploration on COE and GDP trend datasets; in a group of 3.",
    description2:
      "We implemented a Linear Regression model and ran a trading simulation, which the model successfully made a profit.",
    description3:
      "I was involved with Data Preparation, Data Cleaning, Data Visualization, Machine Learning and maintaining the Github Repo.",
    toolsUsed:
      "Tools used: Python, Numpy, Matplotlib, Pandas, Jupyter Notebook",
...
export const hackathonProjects = [
  {
    ...
    description1:
      "Developed a front-end mock-up for an AI resource manager designed for PSA’s ports.",
    description2:
      "Utilised React & CSS for development and hosted on GitHub Pages. React, hosted on GitHub Pages.",
    description3:
